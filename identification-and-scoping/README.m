...
![First ticket and asset inventory](screenshots/01-first-ticket-asset-inventory.png)
...
![Spoofed email investigation](screenshots/02-spoofed-email-investigation.png)
...
![SPF DKIM DMARC check](screenshots/03-spf-dkim-dmarc-check.png)
...
![Phishing domain identified](screenshots/04-phishing-domain-identified.png)
...
![Log escalation request](screenshots/05-log-escalation-request.png)
...
![Second ticket endpoint protection](screenshots/06-second-ticket-endpoint-protection.png)
...
![Spreadsheet of Doom completed](screenshots/07-sod-completed.png)
...
![Room completion](screenshots/08-room-completion.png)
